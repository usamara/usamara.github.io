...
## 7.	Predicting of Diabetes and Prediabetes Given Various Health and Lifestyle Factors
...
Using data on the Los Angeles Dodgers Major League Baseball (MLB) team, make a recommendation to management on how to improve attendance. Tell a story with EDA analysis and clearly explain the steps for management as action point.
